...
nyt_train_mask = np.load('../data/nyt_train_mask.npy')
nyt_test_data = np.load('../data/nyt_test_data.npy')
nyt_test_label = np.load('../data/nyt_test_label.npy')
nyt_test_mask = np.load('../data/nyt_test_mask.npy')
...
new_nyt_train_mask = nyt_train_mask[nyt_train_label != relation_id]
new_nyt_test_data = nyt_test_data[nyt_test_label != relation_id]
new_nyt_test_label = nyt_test_label[nyt_test_label != relation_id]
new_nyt_test_mask = nyt_test_mask[nyt_test_label != relation_id]
#save
...
np.save('../data/nyt_train_mask_.npy', new_nyt_train_mask)
np.save('../data/nyt_test_data_.npy', new_nyt_test_data)
np.save('../data/nyt_test_label_.npy', new_nyt_test_label)
np.save('../data/nyt_test_mask_.npy', new_nyt_test_mask)