...
source_mask_train = os.path.join(source_data_root, 'nyt_train_mask_.npy')
...
source_mask_test = os.path.join(source_data_root, 'nyt_test_mask_.npy')
...
source_dataset = torch.utils.data.TensorDataset(source_train_data, source_train_label)
...
for epoch in range(n_epoch):
    ...
    while i < len_dataloader:
        ...
        class_output,_ = my_net(input_data=inputv_data, alpha=alpha)
